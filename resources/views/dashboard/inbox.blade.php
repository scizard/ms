                                        ...
                                        <div class="">
                                            <div class="mail-body">
                                                ...
                                                <form action="{{ route('landlord.reply') }}" method="post">
                                                        ...
                                                        <input type="text" name="message" placeholder="Reply to sender" required="" style="width: 100%;">
                                                        <input name="to" value="{{$message->from}}" hidden>
                                                        <input name="subject" value="{{$message->subject}}" hidden>
                                                    <button type="submit" class="btn btn-success pull-right" style="width: 100px;"><i class="fa fa-reply"></i> reply</button>
