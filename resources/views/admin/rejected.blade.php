    ...
    <div class="main-page">
        <div class="container-fluid">
            <div class="activity_box activity_box2">
                <h3 class="text-center">Rejected Lease Requests
                    @if($rejected->total() > 0 )
                        <br>Showing <strong>{{ count($rejected) }}</strong> records
                        of <strong>{{ $rejected->total() }}</strong>
                    @endif
                </h3>
                <div class="" id="style-3">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($rejected as $house)
                                    <tr>
                                        ...
                                        <td><a href="/admin/requests/cancel/{{$house->id}}" class="btn btn-warning
                                        pull-right">cancel</a>
                                        </td>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-md-12 bg-parent">
                        .
                        <div class="pull-right">{{ $rejected->links() }}</div>
                    </div>
                </div>
            </div>
