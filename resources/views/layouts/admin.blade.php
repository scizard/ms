...
<div class="main-content">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('admin.statements') }}"><i class="fa fa-angle-right"></i> Mini statement</a>
                                </li>
                                {{--<li><a href="{{ route('comingSoon') }}"><i class="fa fa-angle-right"></i> View Debts</a></li>--}}

                                {{--<li><a href="{{ route('comingSoon') }}"><i class="fa fa-angle-right"></i> Credit Landlord</a></li>--}}
                        ...
                        <li class="treeview active">
                            <a href="#">
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                @if(auth()->user()->requests != 0)
                                <i class="badge badge-danger pull-right">
                                    {{number_format(auth()->user()->requests)}}
                                </i>
                                @endif
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="{{ route('admin.leaseRequests') }}"><i class="fa fa-angle-right"></i> Lease Requests
                                        @if(auth()->user()->requests != 0)
                                            <i class="badge badge-danger pull-center">
                                                {{number_format(auth()->user()->requests)}}
                                            </i>
                                        @endif
                                    </a>
                                <li><a href="{{ route('admin.acceptedRequests') }}"><i class="fa fa-angle-right"></i> Accepted Requests</a></li>
                                <li><a href="{{ route('admin.rejectedRequests') }}"><i class="fa fa-angle-right"></i> Rejected Requests</a>
                                </li>
                                <li><a href="{{ route('admin.addHouse') }}"><i class="fa fa-angle-right"></i> New houses</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('admin.inbox') }}"><i class="fa fa-angle-right"></i> Inbox <i class="badge badge-danger pull-right">{{auth()->user()->messages}}</i></a> </li>
                                <li><a href="{{ route('admin.compose') }}"><i class="fa fa-angle-right"></i> Send Message</a></li>
                                <li><a href="{{ route('admin.broadcast') }}"><i class="fa fa-angle-right"></i> Broadcast </a></li>
                            </ul>
                        </li>
    ...
    <div class="sticky-header header-section " style=" background: #00a78e;">
        ...
        <div class="header-left">
            ...
            <a href="{{ route('admin.inbox') }}" class="dropdown-toggle">
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                           <div class="profile_img">
                                ...
                                <div class="user-name">
                                    <p>{{ auth()->user()->name }}</p>
                                    <span style="color: #ffffff;">Administrator</span>
                                </div>
                        ...
                        <ul class="dropdown-menu drp-mnu">
                            <li><a href="{{ route('admin.changePassword') }}"><i class="fa fa-cog"></i> Change Password</a></li>
