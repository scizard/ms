            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="sign-up__header">
                        <center>
                            <h1 class="sign-up__textcontent"><a href="#log-in" class="sign-up__tab is-active">LANDLORD LOGIN</a></h1>
                        </center>
                    </div><!-- .sign-up__header -->

                    <div class="sign-up__main">
                        <form action="{{route('landlord.login')}}" class="sign-up__form is-visible" method="post">
